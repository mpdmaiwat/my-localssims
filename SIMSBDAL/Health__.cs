...
namespace SIMSBDAL
{
    ...
    public class HealthInformation: baseHealth
    {
        ...
        public void INSERT_STUDENT_HEALTH_DETAILS(string _snum, bool _iscongenital, string _congenital,
                                        ...
                                        string _nurserRemarks, string _illOthers, string _HEALTHSTATUSCODE,bool _heartProblem, string _USERID)
        {
            ...
            using (SqlConnection cn = new SqlConnection(CS))
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("@HEARTPROBLEM", _heartProblem);
